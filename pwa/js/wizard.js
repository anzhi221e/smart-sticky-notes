...
-- Set it as private, then add RLS policies for SELECT/INSERT/DELETE`.trim();
    ...
    if (step === 1) {
        ...
        container.innerHTML = `
            ...
            <div style="text-align:left;margin-top:16px;font-size:14px;color:var(--text-secondary);line-height:1.8;">
                ...
                <p>3. 设置环境变量后运行:</p>
                <pre style="background:var(--bg);padding:8px;border-radius:6px;margin:4px 0;font-size:12px;">SUPABASE_URL=你的URL SUPABASE_ANON_KEY=你的KEY python main.py</pre>
